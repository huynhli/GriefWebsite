	...
	return (
		<div className={`flex flex-row w-full justify-center h-[70px] px-2`}>
			...
			<div className="flex flex-row items-center text-white">
				...
				<div className="w-55 text-center"><a onClick={() => scrollToSpot(0)} className={`inline-block mx-10 cursor-pointer font-bold text-5xl transition-all duration-300 hover:scale-125 `}>Grief</a></div>
